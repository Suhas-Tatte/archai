...
# --------------------------------------------------
# CREATE FRESH LOG FILE EVERY RUN
# --------------------------------------------------

#open("query_output_log.txt", "w", encoding="utf-8").close()
...
def ask_question(question):
    ...
    # --------------------------------------------------
    # CASE 1: Location + Structure Type
    # --------------------------------------------------
